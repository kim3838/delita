...
class BaseShiftStoreAndUpdateRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'type' => ['required', 'integer', Rule::in([ShiftType::REGULAR, ShiftType::GRAVEYARD])],
    ...
    public function messages(): array
    {
        return [
            ...
            'type.in' => 'Invalid shift type',
            'holiday_policy.required' => 'Holiday policy is required',
            'holiday_policy.in' => 'Invalid holiday policy',
            'except_holidays.array' => 'Except holidays must be an array',
            'work_start_grace_time.required' => 'Work start grace time is required',
            'work_start_grace_time.integer' => 'Work start grace time must be an integer',
