...
class ListTransformer extends TransformerAbstract
{
    public function transform(Attendance $attendance): array
    {
        ...
        return [
            ...
            'first_in' => $attendance->first_in->toDateTimeString(),
            'lunch_out' => $attendance->lunch_out?->toDateTimeString(),
            'lunch_in' => $attendance->lunch_in?->toDateTimeString(),
            'last_out' => $attendance->last_out->toDateTimeString(),
