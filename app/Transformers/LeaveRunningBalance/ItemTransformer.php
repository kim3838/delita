...
class ItemTransformer extends TransformerAbstract
{
    public function transform(RunningBalance $runningBalance): array
    {
        return [
            ...
            'employment_type' => $runningBalance->employment_type?->toArray(),
            'period_type' => $runningBalance->period_type?->toArray(),
            'period_interval_span_type' => $runningBalance->period_interval_span_type?->toArray(),
            'carry_over_balance_per_new_period' => $runningBalance->carry_over_balance_per_new_period,
            'carry_over_balance_type' => $runningBalance->carry_over_balance_type?->toArray(),
