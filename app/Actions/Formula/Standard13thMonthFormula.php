            ...
            if ($reconcilePayrollMonthTrigger) {
                ...
                if($adjustment->toScale(2, RoundingMode::HalfUp)->isLessThan(BigDecimal::zero())){
                    ...
                    $context->statementDetails[] = [
                        ...
                        'taxable' => $taxableNegativeAdjustment->toScale(6, RoundingMode::HalfUp)->toString(),
                        'nontaxable' => 0.0,
                        'deduction' => $nontaxableNegativeAdjustment->toScale(6, RoundingMode::HalfUp)->toString(),
                        'contribution' => 0.0,
                        'withholding_tax' => 0.0,
                        'net' => 0.0,
                    ];
                ...
                if($adjustment->toScale(2, RoundingMode::HalfUp)->isGreaterThan(BigDecimal::zero())){
                    ...
                    if(
                        ...
                        $context->statementDetails[] = [
                            ...
                            'taxable' => $taxableAdjustment->toScale(6, RoundingMode::HalfUp)->toString(),
                            'nontaxable' => $nontaxableAdjustment->toScale(6, RoundingMode::HalfUp)->toString(),
                            'deduction' => 0.0,
                            'contribution' => 0.0,
                            'withholding_tax' => 0.0,
                            'net' => 0.0,
